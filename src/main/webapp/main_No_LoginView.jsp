                    ...
                    <div class=" col-sm-10 row">
                        ...
                        <div class="col-sm-4 row user-interact">
                            <div class="col-sm-4 upload">
                                <a class="btn" href="login"><i class="fa-solid fa-plus"></i>&nbsp; Upload</a>
                            </div>
                            <div class="col-sm-1"></div>
                            <div class=" col-sm-3 ">
...
<!--                            <div class=" col-sm-3 Setting">
        ...
        <script>
                        ...
                        <div class=" col-sm-8 h2 content bg-light row">
                            <div class="col-sm-2 row ava-content">
         ...
         <a href="#" class=" align-self-center content-btnlike btn btn-primary mt-5 col-sm-12">
                                                <i class=" heart-icon bi bi-chat-fill"></i>
                                            </a>
                                             <h4 class="col-sm-12" style="padding:10px 0 0 15px;">` + video.numberOfComment + `</h4>
                                            <button class=" align-self-center content-btnlike btn btn-primary mt-5 col-sm-12">
